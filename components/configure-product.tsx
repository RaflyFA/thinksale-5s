    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b p-4 flex justify-between items-center">
          <h2 className="text-lg font-bold">Konfigurasi Produk</h2>
        ...
        {showForm ? (
          ...
          <form onSubmit={handleSubmitOrder} className="p-6 space-y-6">
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="font-bold mt-2">Total: Rp {formatPrice(totalPrice)}</p>
              </div>
            </div>
          ...
          <div className="p-6 space-y-6">
            {/* Product Image and RAM Selection - layout horizontal */}
                ...
                <div className="flex flex-wrap gap-2">
                  {product.ramOptions.map((ram) => (
                    <Button
                      ...
                      className={`rounded-full text-xs px-3 py-1 transition-all duration-200 ${
            ...
            {/* Quantity */}
            <div>
              <h3 className="font-bold text-lg mb-4">Jumlah</h3>
              <div className="flex items-center">
                ...
                <Button variant="outline" className="h-10 w-10 rounded-full" onClick={() => setQuantity(quantity + 1)}>
                  +
                </Button>
              </div>
            </div>
            ...
            <div className="pt-4 border-t">
              <div className="flex justify-between items-center mb-6">
                ...
                <Button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3" onClick={handleCheckout}>
                  Checkout
                </Button>
              </div>
            </div>
